...
import { GET_ONE_REPOSITORY } from "../graphql/queries"; // Import GET_REPOSITORY GraphQL query string.
...
const useRepository = (id) => {
  ...
  const { data, error, loading, refetch } = useQuery(GET_ONE_REPOSITORY, {
  ...
  if (error) {
    console.error("GraphQL Error fetching single repository:", error);
  }
